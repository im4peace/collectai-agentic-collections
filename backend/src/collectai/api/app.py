"""FastAPI application factory (E1-S5, extended by E3-S1 and Group E).
Wires the RBAC error envelope, correlation-id middleware and every router.
CORS is left to a later story (folder-structure.md's `deploy/nginx`
terminates the public edge in the demo compose stack; no story in this
group needs cross-origin API access yet).
